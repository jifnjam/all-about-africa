...
napolygonSeries.mapPolygons.template.setAll({
  tooltipText: "Country: {name}",
  interactive: true
});

napolygonSeries.mapPolygons.template.states.create("hover", {
  fill: am5.color(0x375f1b)
});
  ...
  const map = {
    ...
    features: [
      ...
      },
      {
        ...
        properties: { name: "C̫te d'Ivoire", id: "CI", Continent: "Africa" },
        id: "CI"
      },
      {
        type: "Feature",
...
wapolygonSeries.mapPolygons.template.setAll({
  tooltipText: "Country: {name}",
  interactive: true
});

wapolygonSeries.mapPolygons.template.states.create("hover", {
  fill: am5.color(0x375f1b)
});
...
capolygonSeries.mapPolygons.template.setAll({
  tooltipText: "Country: {name}",
  interactive: true
});

capolygonSeries.mapPolygons.template.states.create("hover", {
  fill: am5.color(0x375f1b)
});
...
eapolygonSeries.mapPolygons.template.setAll({
  tooltipText: "Country: {name}",
  interactive: true
});

eapolygonSeries.mapPolygons.template.states.create("hover", {
  fill: am5.color(0x375f1b)
});
...
sapolygonSeries.mapPolygons.template.setAll({
  tooltipText: "Country: {name}",
  interactive: true
});

sapolygonSeries.mapPolygons.template.states.create("hover", {
  fill: am5.color(0x375f1b)
});
